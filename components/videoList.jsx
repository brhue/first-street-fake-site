        ...
        return (
          <div key={video.id} className="mb-10 grid lg:grid-cols-2 lg:gap-4">
            <div className="mb-10">
              ...
              <div className="overflow-hidden max-h-48 relative after:absolute after:inset-0 after:from-white after:bg-gradient-to-t">
                <p
                  className="text-lg md:text-xl lg:text-[22px] leading-7 text-blueish"
